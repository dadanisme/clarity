  ...
  return (
    <Card className="border-dashed animate-in fade-in-0 zoom-in-95 slide-in-from-bottom-8 duration-700 ease-out">
      <CardHeader className="text-center">
        ...
        <CardTitle className="text-lg animate-in fade-in-0 slide-in-from-left-4 duration-500 delay-300 ease-out">
          {metadata.name} Required
        </CardTitle>
        <CardDescription className="animate-in fade-in-0 slide-in-from-right-4 duration-500 delay-400 ease-out">
          {metadata.description}
        </CardDescription>
      </CardHeader>
      <CardContent className="text-center">
        <p className="mb-4 text-sm text-muted-foreground animate-in fade-in-0 zoom-in-95 duration-400 delay-500 ease-out">
          This feature is not available in your current plan. Contact an
          administrator to enable this feature.
        </p>
        <Button
          variant="outline"
          disabled
          className="animate-in fade-in-0 slide-in-from-bottom-4 zoom-in-95 duration-500 delay-600 ease-out hover:scale-105 transition-transform"
        >
          Feature Locked
        </Button>
      </CardContent>
